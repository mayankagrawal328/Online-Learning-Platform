        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link
                to="https://github.com/mayankagrawal328/Online-Learning-Platform"
                target="__blank"
          ...
          <div className="flex items-center">
            <a
              href="https://www.linkedin.com/in/mayank-agrawal-001047222/"
            ...
            <a
              href="https://github.com/mayankagrawal328/Online-Learning-Platform"
              className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
